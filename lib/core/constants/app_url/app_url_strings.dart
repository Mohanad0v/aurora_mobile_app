...
//////////////////////////////for sharing and runing other device the mobile and the laptop should be on the same network then run ipconfigue on cmd then take you laptop ip4 address ////
class AppUrls {
    static String _baseUrl = "http://192.168.001.110:4000"; // default
    ...
    /// Reviews
    static String getReviewsByProperty(String propertyId) =>
